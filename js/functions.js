(function($){
    ...
    // Procurar & cart option
    $(document).on('click','.Procurar-cart .Procurar i, .Procurar-close',function(){
        $(".Procurar-area").toggleClass("open");
    });

    // SERVIÇOS slider 
    var swiper = new Swiper('.SERVIÇOS-slider', {
        slidesPerView: 3,
        pagination: {
            el: '.SERVIÇOS-pagination',
            clickable: true,
        },
        speed: 1200,
        autoplay: {
    ...
    // Perguntas frequentes section start here
    $(function(){
    ...
    // Serviço single section start here
    $(function(){
        var tabWrapper = $('.Serviço-single .section-wrapper, .product-review .section-wrapper'),
