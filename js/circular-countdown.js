    ...
    var clock = {
        set: {
            days: function() {
                ...
                ctx.arc(54.5, 54.5, 53.5, deg(0), deg(360 / glob.total * (glob.total - glob.days)));
                ctx.lineWidth = 14;
                ctx.stroke();
            ...
            hours: function() {
                ...
                ctx.arc(54.5, 54.5, 53.5, deg(0), deg(15 * glob.hours));
                ctx.lineWidth = 6;
                ctx.stroke();
            ...
            minutes: function() {
                ...
                ctx.arc(54.5, 54.5, 53.5, deg(0), deg(6 * glob.minutes));
                ctx.lineWidth = 6;
                ctx.stroke();
            ...
            seconds: function() {
                ...
                ctx.arc(54.5, 54.5, 53.5, deg(0), deg(6 * glob.seconds));
                ctx.lineWidth = 6;
                ctx.stroke();
